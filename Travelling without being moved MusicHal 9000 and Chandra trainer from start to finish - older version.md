...
- Plomp, R., & Levelt, W. J. M. (1965). Tonal Consonance and Critical Bandwidth. *The Journal of the Acoustical Society of America*. [Critical bands/roughness]
- Parncutt, R. (1989). *Harmony: A Psychoacoustical Approach*. Springer. [Modern harmonic perception]
- Sethares, W. A. (1998). *Tuning, Timbre, Spectrum, Scale*. Springer. [Harmonicity across timbres/tunings]
- Rhythm (separate pathway): Brandtsegg, Ø. Rhythm ratio analysis (inter‑onset proportions/polyrhythms).
